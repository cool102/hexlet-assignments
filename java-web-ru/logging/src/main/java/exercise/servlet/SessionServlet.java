...
public class SessionServlet extends HttpServlet {
    ...
    private void login(HttpServletRequest request,
        ...
        // BEGIN
        LOGGER.log(Level.INFO,"User with email: " + email + "successfully logged");
        // END
        ...
        if (user == null || !user.get("password").equals(password)) {
            ...
            TemplateEngineUtil.render("session/login.html", request, response);
            LOGGER.log(Level.INFO,"Unsuccessful login of user with email: " + email);
            return;
        }
        ...
        LOGGER.log(Level.INFO,"Successful login of user with email: " + email);
    }
