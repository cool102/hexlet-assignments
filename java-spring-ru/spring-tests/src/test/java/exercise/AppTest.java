...
public class AppTest {
    ...
    void updatePeople() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(
                        patch("/people/1")
                                ...
                                .content("{\"firstName\": \"Milsten\", \"lastName\": \"Nerger\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(response2.getContentAsString()).contains("Milsten");
        assertThat(response2.getContentAsString()).contains("Nerger");
